...
Currently, ${totalUnfundedGames} game${totalUnfundedGames != 1 ? 's' : ''} remain${totalUnfundedGames != 1 ? '': 's'} unfunded. We need 
your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const displayMessage = document.createElement("p");
displayMessage.innerHTML = displayStr;
descriptionContainer.appendChild(displayMessage);
